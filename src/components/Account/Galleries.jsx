    ...
    <>
      <div className="space-y-3 ">
        <div className=" ">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-between gap-2 p-2">
            {/* Skeleton Cards */}
            {skeletonCards.map((_, index) => (
              <div
                key={index}
                className="relative min-w-[230px] h-[220px] rounded-lg overflow-hidden bg-gradient-to-r from-[#1a1a1a] to-[#222324] flex flex-col justify-end p-4"
              >
