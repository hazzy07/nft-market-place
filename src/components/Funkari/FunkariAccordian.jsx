  ...
  return (
    <div className="">
      <button
        ...
        className="flex  justify-between w-full py-4 px-6 text-white font-inter font-[400] text-[14px]"
      >
        {title}
        <RxCaretDown
          size={21}
      ...
      {open && (
        <div className="px-5 border-b border-[#48484ba9] py-6">{children}</div>
      )}
    </div>
  );
};
export default function FunkariAccordian({
  activeCategory,
  setActiveCategory,
}) {
  ...
  return (
    <div className="text-white border-b border-[#48484ba9]">
