...
export default function TokenAccordian() {
    ...
    <>
      <div className="flex w-full">
        ...
        <div className=" w-full text-white overflow-hidden">
          <AccordionItem title="Market Cap">
          ...
          <AccordionItem title="Category">
            <p className="text-[14px] font-[400] py-4 font-inter ">
              Slider or input here
            </p>
          </AccordionItem>

        

          <ToggleSwitch label="Has NFT" />
          <ToggleSwitch label="Branded Token Page" />
        </div>
      </div>
    </>
  );
